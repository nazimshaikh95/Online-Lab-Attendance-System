<%-- 
    Document   : userReport
    Created on : 30 Jan, 2018, 1:58:38 AM
    Author     : Nazimsk
--%>
...
<div class="w3-container">
     ...
     <div class="w3-bar w3-black">
   	...
   	<a href="user1.jsp" class="w3-bar-item w3-button">Attendance</a>
...
<form action="pj3.jsp" method="post">

	<tr>
		<td align="center">Roll no</td>
		<td><input type="text" class="input-field" name="Roll no" value="0"></td>
	</tr>
	<tr>
		<td align="center">Student Name</td>
		<td><input type="text" class="input-field" placeholder="Optional Field" name="Student"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="center"><input type="submit" value="Generate Report">
