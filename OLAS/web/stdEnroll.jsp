<%-- 
    Document   : studEnroll
    Created on : 29 Jan, 2018, 12:44:29 AM
    Author     : Nazimsk
--%>
...
<form action="datastud.jsp" method="post">

	
	<tr>
		<td align="center">Roll No</td>
		<td><input type="text" class="input-field" name="RollNo"></td>
	
	</tr>
        </tr>
	<tr>
		<td align="center">Student Name</td>
		<td><input type="text" class="input-field" name="StudentName"></td>
	</tr>
	<tr>
		<td align="center">Scheme:</td>
		<td><select class="select-field" name="Scheme">
	...
	<tr>
		...
		<td><select class="select-field" name="year">
	...
	<tr>
		...
		<td><textarea type="text" class="textarea-field" name="Address"></textarea></td>
	</tr>
        <tr>
	...
	<tr>
		...
		<td><input type="email"  class="input-field" value="@gmail.com" name="Em"></td>
	</tr>
	</div>
</table>	
